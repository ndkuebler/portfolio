...
export const IDEATION_CONCEPTS: IdeationConcept[] = [
  {
    ...
    title: "Stills",
    subtitle:
      "A small patinated brass button with a concealed microphone, designed to clip onto whatever you carry most: a bag strap, a jacket lapel, a notebook. Once per day at a moment of its own choosing, it captures eight seconds of whatever you happen to be hearing. You don't know when. You might miss noticing it entirely. Over a month it collects thirty random audio snapshots of your ordinary life, a stranger laughing in a café, your footsteps on a quiet street, a scrap of music from a passing car, the silence of your desk. Dock the button and listen back. A diary written entirely by chance, capturing a texture of daily life that nothing else preserves.",
    thumb: "/ideate/stills-thumb.webp",
    mediaType: "image",
    mediaSrc: "/ideate/stills.webp",
